...
STRICT_OVERUSE_BLOCK = False       # Disable infinite cost blocks - use finite present cost only
HIST_COST_WEIGHT = 10.0            # Weight for historical cost component (will be scaled by layer count)
...
class PathFinderConfig:
    ...
    history_decay: float = 1.0                 # History decay factor (1.0 = no decay, full memory)
